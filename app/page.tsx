      ...
      <section className="relative pt-32 pb-20 sm:pt-48 sm:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 mb-8">
            ...
            <span className="text-xs font-bold text-blue-700 uppercase tracking-[0.2em]">100% Private & Local</span>
          </div>
          ...
          <p className="max-w-2xl mx-auto text-lg sm:text-xl text-slate-600 leading-relaxed mb-12">
            ...
            No uploads, no registration, and no data collection.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
            <Link href="/tools" className="w-full sm:w-auto px-8 py-4 bg-blue-600 text-white font-bold rounded-2xl hover:bg-blue-700 transition-all active:scale-95 shadow-xl shadow-blue-100 text-lg">
              Explore All Tools
            </Link>
            <Link href="/tools/merge" className="w-full sm:w-auto px-8 py-4 bg-white text-slate-900 font-bold rounded-2xl border border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-all active:scale-95 text-lg">
              Try Merge PDF
            </Link>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-8 text-slate-400">
            <div className="flex flex-col items-center gap-1">
              ...
              <span className="text-[10px] uppercase tracking-[0.2em] font-bold">Client Side</span>
            </div>
            <div className="hidden sm:block w-px h-8 bg-slate-200"></div>
            <div className="flex flex-col items-center gap-1">
              <span className="text-2xl font-bold text-slate-900">Fast</span>
              <span className="text-[10px] uppercase tracking-[0.2em] font-bold">Processing</span>
            </div>
            <div className="hidden sm:block w-px h-8 bg-slate-200"></div>
            <div className="flex flex-col items-center gap-1">
              <span className="text-2xl font-bold text-slate-900">Secure</span>
              <span className="text-[10px] uppercase tracking-[0.2em] font-bold">By Design</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500">Quickly handle your most common PDF tasks.</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Link
              ...
              >
                ...
                <p className="text-slate-500 mb-6 leading-relaxed">{tool.description}</p>
          ...
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-16">
            <div className="flex-1 text-left">
              <h2 className="text-4xl font-black text-slate-900 mb-6 leading-tight">
                ...
                <span className="text-blue-600 underline decoration-blue-100 underline-offset-8">top priority.</span>
              </h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Most PDF editors upload your files to their servers. We don't. 
            ...
            <div className="flex-1 w-full max-w-md">
              <div className="relative">
                ...
                <div className="relative bg-white rounded-[3rem] shadow-2xl p-12 border border-slate-100 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-4">Zero Upload Policy</h3>
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          <div className="bg-slate-900 rounded-[3rem] p-12 text-white relative overflow-hidden shadow-2xl shadow-slate-200">
            <h2 className="text-4xl font-bold mb-6 relative">Ready to manage your PDFs?</h2>
            <p className="text-slate-300 text-lg mb-10 max-w-2xl mx-auto relative">
              Get access to all our professional PDF tools right now, absolutely free and 100% private.
            </p>
            <Link href="/tools" className="relative inline-flex items-center px-8 py-4 bg-blue-600 text-white font-bold rounded-2xl hover:bg-blue-700 transition-all active:scale-95 shadow-xl text-lg">
